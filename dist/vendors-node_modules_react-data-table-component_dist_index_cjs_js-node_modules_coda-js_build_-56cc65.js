(self["webpackChunktalent_coda"] = self["webpackChunktalent_coda"] || []).push([["vendors-node_modules_react-data-table-component_dist_index_cjs_js-node_modules_coda-js_build_-56cc65"],{
...
/***/ "./node_modules/coda-js/build/index.mjs":
/*!**********************************************!*\
  !*** ./node_modules/coda-js/build/index.mjs ***!
  \**********************************************/
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BadRequestError: () => (/* binding */ a),
/* harmony export */   Coda: () => (/* binding */ O),
/* harmony export */   ForbiddenError: () => (/* binding */ l),
/* harmony export */   GoneError: () => (/* binding */ f),
/* harmony export */   NotFoundError: () => (/* binding */ h),
/* harmony export */   TooManyRequestsError: () => (/* binding */ P),
/* harmony export */   UnauthorizedError: () => (/* binding */ d)
/* harmony export */ });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
function e(){return(e=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(t[n]=r[n])}return t}).apply(this,arguments)}function r(t,e){t.prototype=Object.create(e.prototype),t.prototype.constructor=t,o(t,e)}function n(t){return(n=Object.setPrototypeOf?Object.getPrototypeOf:function(t){return t.__proto__||Object.getPrototypeOf(t)})(t)}function o(t,e){return(o=Object.setPrototypeOf||function(t,e){return t.__proto__=e,t})(t,e)}function s(){if("undefined"==typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch(t){return!1}}function c(t,e,r){return(c=s()?Reflect.construct:function(t,e,r){var n=[null];n.push.apply(n,e);var s=new(Function.bind.apply(t,n));return r&&o(s,r.prototype),s}).apply(null,arguments)}function u(t){var e="function"==typeof Map?new Map:void 0;return(u=function(t){if(null===t||-1===Function.toString.call(t).indexOf("[native code]"))return t;if("function"!=typeof t)throw new TypeError("Super expression must either be null or a function");if(void 0!==e){if(e.has(t))return e.get(t);e.set(t,r)}function r(){return c(t,arguments,n(this).constructor)}return r.prototype=Object.create(t.prototype,{constructor:{value:r,enumerable:!1,writable:!0,configurable:!0}}),o(r,t)})(t)}function i(t){if(void 0===t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return t}var a=function(t){function e(r){var n;return(n=t.call(this,r)||this).name="BadRequestError",Object.setPrototypeOf(i(n),e.prototype),n}return r(e,t),e}(u(Error)),d=function(t){function e(r){var n;return(n=t.call(this,r)||this).name="UnauthorizedError",Object.setPrototypeOf(i(n),e.prototype),n}return r(e,t),e}(u(Error)),l=function(t){function e(r){var n;return(n=t.call(this,r)||this).name="ForbiddenError",Object.setPrototypeOf(i(n),e.prototype),n}return r(e,t),e}(u(Error)),h=function(t){function e(r){var n;return(n=t.call(this,r)||this).name="NotFoundError",Object.setPrototypeOf(i(n),e.prototype),n}return r(e,t),e}(u(Error)),f=function(t){function e(r){var n;return(n=t.call(this,r)||this).name="GoneError",Object.setPrototypeOf(i(n),e.prototype),n}return r(e,t),e}(u(Error)),P=function(t){function e(r){var n;return(n=t.call(this,r)||this).name="TooManyRequestsError",Object.setPrototypeOf(i(n),e.prototype),n}return r(e,t),e}(u(Error)),m=function(){function e(e){this._axiosInstance=axios__WEBPACK_IMPORTED_MODULE_0__.create({baseURL:"https://coda.io/apis/v1",headers:{Authorization:"Bearer "+e}})}var r=e.prototype;return r.request=function(t,e,r){void 0===e&&(e={}),void 0===r&&(r="GET");try{var n=["POST","PUT","PATCH"].includes(r.toUpperCase())?{url:t,method:r,data:e}:{url:t,method:r,params:e};return Promise.resolve(this._axiosInstance(n).catch(I))}catch(t){return Promise.reject(t)}},r.deleteWithBody=function(t,e){void 0===e&&(e={});try{return Promise.resolve(this._axiosInstance({url:t,method:"DELETE",data:e}).catch(I))}catch(t){return Promise.reject(t)}},e}();function I(t){if(t.response)switch(t.response.status){case 400:throw new a(t.response.statusText);case 401:throw new d(t.response.statusText);case 403:throw new l(t.response.statusText);case 404:throw new h(t.response.statusText);case 429:throw new P(t.response.statusText)}throw t}var p=function(t){Object.assign(this,t)},v=function(t){if(!Array.isArray(t))throw new Error("`rows` must be an array");if(!t.length)throw new Error("Must include at least one row when calling `insertRows`");return t.map(function(t){if(Array.isArray(t)){if(t.some(function(t){return t.hasOwnProperty("column")&&t.hasOwnProperty("value")}))return{cells:t};throw new Error("A row must either be an array of objects for each column, or else one object of column/value pairs..")}var e=[];return Object.keys(t).forEach(function(r){e.push({column:r,value:t[r]})}),{cells:e}})},w=function(){function t(t,e){this.API=t,this.requestId=e}return t.prototype.isCompleted=function(){try{return Promise.resolve(this.API.request("/mutationStatus/"+this.requestId)).then(function(t){return t.data.completed})}catch(t){return Promise.reject(t)}},t}(),y=function(){function t(t,e){this.API=t,Object.assign(this,e)}var e=t.prototype;return e.listValues=function(){var t=this,e=[];return Object.keys(this.values).forEach(function(r){e.push({column:r,value:t.values[r]})}),e},e.update=function(t){try{var e=this,r=v([t]);return Promise.resolve(e.API.request("/docs/"+e.docId+"/tables/"+e.tableId+"/rows/"+e.id,{row:r[0]},"PUT")).then(function(t){return new w(e.API,t.data.requestId)})}catch(t){return Promise.reject(t)}},e.delete=function(){try{var t=this;return Promise.resolve(t.API.request("/docs/"+t.docId+"/tables/"+t.tableId+"/rows/"+t.id,{},"DELETE")).then(function(e){return new w(t.API,e.data.requestId)})}catch(t){return Promise.reject(t)}},t}(),b=function(){function t(t,e){this.API=t,Object.assign(this,e)}var r=t.prototype;return r.listColumns=function(t){try{var r=this;return Promise.resolve(r.API.request("/docs/"+r.docId+"/tables/"+r.id+"/columns",t)).then(function(t){return t.data.items.map(function(t){return new p(e({},t,{docId:r.docId,tableId:r.id}))})})}catch(t){return Promise.reject(t)}},r.getColumn=function(t){try{var r=this;return Promise.resolve(r.API.request("/docs/"+r.docId+"/tables/"+r.id+"/columns/"+t)).then(function(t){return new p(e({},t.data,{docId:r.docId,tableId:r.id}))})}catch(t){return Promise.reject(t)}},r.listRows=function(t){try{var r=this;return Promise.resolve(r.API.request("/docs/"+r.docId+"/tables/"+r.id+"/rows",t)).then(function(t){return t.data.items.map(function(t){return new y(r.API,e({},t,{docId:r.docId,tableId:r.id}))})})}catch(t){return Promise.reject(t)}},r.listRowsPaginatedByToken=function(t){try{var r=this;return Promise.resolve(r.API.request("/docs/"+r.docId+"/tables/"+r.id+"/rows",t)).then(function(t){var n=t.data;return{items:n.items.map(function(t){return new y(r.API,e({},t,{docId:r.docId,tableId:r.id}))}),token:n.nextPageToken}})}catch(t){return Promise.reject(t)}},r.getRow=function(t,r){try{var n=this;return Promise.resolve(n.API.request("/docs/"+n.docId+"/tables/"+n.id+"/rows/"+t,r)).then(function(t){return new y(n.API,e({},t.data,{docId:n.docId,tableId:n.id}))})}catch(t){return Promise.reject(t)}},r.insertRows=function(t,e){void 0===t&&(t=[]),void 0===e&&(e=[]);try{var r=this,n=v(t);return Promise.resolve(r.API.request("/docs/"+r.docId+"/tables/"+r.id+"/rows",{rows:n,keyColumns:e},"POST")).then(function(t){return new w(r.API,t.data.requestId)})}catch(t){return Promise.reject(t)}},r.updateRow=function(t,e){try{var r=this,n=v([e]);return Promise.resolve(r.API.request("/docs/"+r.docId+"/tables/"+r.id+"/rows/"+t,{row:n[0]},"PUT")).then(function(t){return new w(r.API,t.data.requestId)})}catch(t){return Promise.reject(t)}},r.deleteRow=function(t){try{var e=this;return Promise.resolve(e.API.request("/docs/"+e.docId+"/tables/"+e.id+"/rows/"+t,{},"DELETE")).then(function(t){return new w(e.API,t.data.requestId)})}catch(t){return Promise.reject(t)}},r.deleteRows=function(t){try{var e=this;return Promise.resolve(e.API.deleteWithBody("/docs/"+e.docId+"/tables/"+e.id+"/rows",{rowIds:t})).then(function(t){return new w(e.API,t.data.requestId)})}catch(t){return Promise.reject(t)}},t}(),A=function(t){Object.assign(this,t)},j=function(t){Object.assign(this,t)},q=function(){function t(t,e){this.API=t,Object.assign(this,e)}var r=t.prototype;return r.listSections=function(t){try{var r=this;return Promise.resolve(r.API.request("/docs/"+r.id+"/sections",t)).then(function(t){return t.data.items.map(function(t){return new A(e({},t,{docId:r.id}))})})}catch(t){return Promise.reject(t)}},r.getSection=function(t){try{var r=this;return Promise.resolve(r.API.request("/docs/"+r.id+"/sections/"+t)).then(function(t){return new A(e({},t.data,{docId:r.id}))})}catch(t){return Promise.reject(t)}},r.listTables=function(){try{var t=this;return Promise.resolve(t.API.request("/docs/"+t.id+"/tables")).then(function(r){return r.data.items.map(function(r){return new b(t.API,e({},r,{docId:t.id}))})})}catch(t){return Promise.reject(t)}},r.getTable=function(t){try{var r=this;return Promise.resolve(r.API.request("/docs/"+r.id+"/tables/"+t)).then(function(t){return new b(r.API,e({},t.data,{docId:r.id}))})}catch(t){return Promise.reject(t)}},r.listControls=function(t){try{var r=this;return Promise.resolve(r.API.request("/docs/"+r.id+"/controls",t)).then(function(t){return t.data.items.map(function(t){return new j(e({},t,{docId:r.id}))})})}catch(t){return Promise.reject(t)}},r.getControl=function(t){try{var r=this;return Promise.resolve(r.API.request("/docs/"+r.id+"/controls/"+t)).then(function(t){return new j(e({},t.data,{docId:r.id}))})}catch(t){return Promise.reject(t)}},t}(),O=function(){function t(t){this.API=new m(t)}var r=t.prototype;return r.whoAmI=function(){try{return Promise.resolve(this.API.request("/whoami")).then(function(t){return t.data})}catch(t){return Promise.reject(t)}},r.listDocs=function(t){void 0===t&&(t={});try{var e=this;return Promise.resolve(e.API.request("/docs",t)).then(function(t){return t.data.items.map(function(t){return new q(e.API,t)})})}catch(t){return Promise.reject(t)}},r.getDoc=function(t){try{var e=this;return Promise.resolve(e.API.request("/docs/"+t)).then(function(t){return new q(e.API,t.data)})}catch(t){return Promise.reject(t)}},r.listPages=function(t,r){try{return Promise.resolve(this.API.request("/docs/"+t+"/Pages",r)).then(function(r){return r.data.items.map(function(r){return new r(e({},r,{docId:t}))})})}catch(t){return Promise.reject(t)}},r.getPage=function(t,r){try{return Promise.resolve(this.API.request("/docs/"+t+"/Pages/"+r)).then(function(r){return new A(e({},r.data,{docId:t}))})}catch(t){return Promise.reject(t)}},r.listTables=function(t){try{var r=this;return Promise.resolve(r.API.request("/docs/"+t+"/tables")).then(function(n){return n.data.items.map(function(n){return new b(r.API,e({},n,{docId:t}))})})}catch(t){return Promise.reject(t)}},r.getTable=function(t,r){try{var n=this;return Promise.resolve(n.API.request("/docs/"+t+"/tables/"+r)).then(function(r){return new b(n.API,e({},r.data,{docId:t}))})}catch(t){return Promise.reject(t)}},r.listColumns=function(t,r,n){try{return Promise.resolve(this.API.request("/docs/"+t+"/tables/"+r+"/columns",n)).then(function(n){return n.data.items.map(function(n){return new p(e({},n,{docId:t,tableId:r}))})})}catch(t){return Promise.reject(t)}},r.getColumn=function(t,r,n){try{return Promise.resolve(this.API.request("/docs/"+t+"/tables/"+r+"/columns/"+n)).then(function(n){return new p(e({},n.data,{docId:t,tableId:r}))})}catch(t){return Promise.reject(t)}},r.listRows=function(t,r,n){try{var o=this;return Promise.resolve(o.API.request("/docs/"+t+"/tables/"+r+"/rows",n)).then(function(n){return n.data.items.map(function(n){return new y(o.API,e({},n,{docId:t,tableId:r}))})})}catch(t){return Promise.reject(t)}},r.getRow=function(t,r,n,o){try{var s=this;return Promise.resolve(s.API.request("/docs/"+t+"/tables/"+r+"/rows/"+n,o)).then(function(n){return new y(s.API,e({},n.data,{docId:t,tableId:r}))})}catch(t){return Promise.reject(t)}},r.insertRows=function(t,e,r,n){void 0===r&&(r=[]),void 0===n&&(n=[]);try{var o=this,s=v(r);return Promise.resolve(o.API.request("/docs/"+t+"/tables/"+e+"/rows",{rows:s,keyColumns:n},"POST")).then(function(t){return new w(o.API,t.data.requestId)})}catch(t){return Promise.reject(t)}},r.updateRow=function(t,e,r,n){try{var o=this,s=v([n]);return Promise.resolve(o.API.request("/docs/"+t+"/tables/"+e+"/rows/"+r,{row:s[0]},"PUT")).then(function(t){return new w(o.API,t.data.requestId)})}catch(t){return Promise.reject(t)}},r.deleteRow=function(t,e,r){try{var n=this;return Promise.resolve(n.API.request("/docs/"+t+"/tables/"+e+"/rows/"+r,{},"DELETE")).then(function(t){return new w(n.API,t.data.requestId)})}catch(t){return Promise.reject(t)}},r.deleteRows=function(t,e,r){try{var n=this;return Promise.resolve(n.API.deleteWithBody("/docs/"+t+"/tables/"+e+"/rows",{rowIds:r})).then(function(t){return new w(n.API,t.data.requestId)})}catch(t){return Promise.reject(t)}},r.mutationStatus=function(t){try{return Promise.resolve(this.API.request("/mutationStatus/"+t)).then(function(t){return t.data.completed})}catch(t){return Promise.reject(t)}},r.listControls=function(t,r){try{return Promise.resolve(this.API.request("/docs/"+t+"/controls",r)).then(function(r){return r.data.items.map(function(r){return new j(e({},r,{docId:t}))})})}catch(t){return Promise.reject(t)}},r.getControl=function(t,r){try{return Promise.resolve(this.API.request("/docs/"+t+"/controls/"+r)).then(function(r){return new j(e({},r.data,{docId:t}))})}catch(t){return Promise.reject(t)}},t}();
...
//# sourceMappingURL=vendors-node_modules_react-data-table-component_dist_index_cjs_js-node_modules_coda-js_build_-56cc65.js.map