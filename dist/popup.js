...
const App = () => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'text-orange-400' }, "App Chrome Extention"));
};
